...
そういうこともあり、[VB.NOT]()のネガキャンやVB離れがあったのは確か
...
アプリは「保存データの構造」押さえたら「自分の土俵」に持ってこれる

アプリのデータ(裏側)の解析して -> 構造理解できたら -> プログラム作れば -> べつのものにコンバート出来る

例えば
ビジネスアプリ -> DBの構造解かる -> 自作プログラム -> データコンバータ/独自帳票
なんかのデザイナ -> ファイルの構造理解 -> 自作プログラム -> なんかのソース
  ドローツール、UMLデザイナ、VB6のIDE、EnterprizeArchitect

これがOSSなら、さらにやりやすい

開発プロセスは「自分らで作るもの」

コンソールアプリにしとくのが、自動化の第一歩
