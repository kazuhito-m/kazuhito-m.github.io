...
「書いたプログラムが一定の基準を満たしているかを合格判定している」っぽいのですが、よーく見てる(〜が使われてませんとか)ので、そういうのが簡単に作れるのなら、調べてみようかなと。

前からやってってたのですが、ふたつ目の終盤くらいで時間切れ…自身はビギナーかつ手は遅い方なのですが、周りの方は `tower-of-babel` くらいから始めて、バリバリ進んでる感じでしたので、かっこいいなーと思ってました。
...
割と会場がそうだったのですが「一斉にやるから会場Wifiと当該サイトが負荷で遅延する」からの「ついていけなくて泣いて帰る」のを嫌って、初期から「自前Wifi＆お手本ソース丸写し」でゴリ押してなんとか終わらせました。
...
- Starting TDD with Node.js
  ...
  - 感想
    - Node界隈は「本気で聞いてます？僕にTDDの話をさせたら長くなりますよ？」なテスト猛ッ者猛者の集合のイメージがあるのですが、わりかし基本からご説明されていたのは「モダナイズにはTDD必須」という啓蒙目的だったのかな？と思いました
