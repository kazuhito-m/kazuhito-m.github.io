...
と「自動化」「Infra as code」を推す者としては「逆方向の啓蒙になってたらヤダ」という思いでした。
...
(他人のために善意の第三者としてネットワークを設定したことある方には特に)
...
+ 本当に実際の「模様し会場のネットワーク設営」でしか体験出来ない、生々しい失敗やリカバリ知見がいっぱい
...
tmux って「ティーマックス」って言うんですね…初めて知りました。
...
会場で「IPAの"パスワード"啓蒙ポスター」がコンプされてました…。
